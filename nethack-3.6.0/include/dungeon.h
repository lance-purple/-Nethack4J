...
#define uz_is_oracle_level() (uz_on_level(&oracle_level))
#define uz_is_valley() (uz_on_level(&valley_level))
#define uz_is_juiblex_level() (uz_on_level(&juiblex_level))
...
#define uz_is_wiz1_level() (uz_on_level(&wiz1_level))
#define uz_is_wiz2_level() (uz_on_level(&wiz2_level))
#define uz_is_wiz3_level() (uz_on_level(&wiz3_level))
...
#define uz_is_bigroom() (uz_on_level(&bigroom_level))
#define uz_is_qstart() (uz_on_level(&qstart_level))
#define uz_is_qlocate() (uz_on_level(&qlocate_level))
#define uz_is_nemesis() (uz_on_level(&nemesis_level))
#define uz_is_knox(x) (uz_on_level(&knox_level))
#define uz_is_mineend_level() (uz_on_level(&mineend_level))
#define uz_is_sokoend_level() (uz_on_level(&sokoend_level))
