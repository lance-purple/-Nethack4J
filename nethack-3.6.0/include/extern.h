...
E xchar NDECL(dunlevs_in_uz_dungeon);
...
E boolean NDECL(uz_is_botlevel);
E boolean NDECL(uz_can_fall_thru);
E boolean NDECL(uz_can_dig_down);
...
E boolean NDECL(uz_in_hell);
E boolean NDECL(uz_in_V_tower);
E boolean FDECL(On_W_tower_level, (d_level *));
E boolean NDECL(uz_on_W_tower_level);
E boolean FDECL(uz_in_W_tower, (int, int));
...
E void FDECL(priestini, (struct mkroom *, int, int, BOOLEAN_P));
